...
urlpatterns = [
    ...
    #path('kakeibo/income/<int:pk>/detail',views.DetailIncomeView.as_view(), name='detail-income'),
    ...
    #path('kakeibo/payment/<int:pk>/detail',views.DetailPaymentView.as_view(), name='detail-payment'),
